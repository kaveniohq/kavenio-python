...
class PreviewQueueSlots200ResponseAnyOfDataSlotsInner(BaseModel):
    """
    ...
    time: StrictStr
    timezone: StrictStr
    scheduled_for: Optional[datetime] = Field(alias="scheduledFor")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["queueId", "profileId", "dayOfWeek", "time", "timezone", "scheduledFor"]
