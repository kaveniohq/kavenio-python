...
class ListYouTubePlaylists200ResponseAnyOfDataPlaylistsInner(BaseModel):
    """
    ...
    item_count: Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]] = Field(default=None, alias="itemCount")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "channelId", "title", "description", "privacyStatus", "thumbnailUrl", "itemCount"]
