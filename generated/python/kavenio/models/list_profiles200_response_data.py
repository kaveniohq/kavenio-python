...
class ListProfiles200ResponseData(BaseModel):
    """
    ListProfiles200ResponseData
    """ # noqa: E501
    profiles: List[ListProfiles200ResponseDataProfilesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "profiles": [ListProfiles200ResponseDataProfilesInner.from_dict(_item) for _item in obj["profiles"]] if obj.get("profiles") is not None else None
        })
